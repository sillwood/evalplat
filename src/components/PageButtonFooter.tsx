interface Props {
    handleClick: (valence: number) => void;
}
            ...
            <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                ...
                <div>
                    ...
                    >
                        <div
                            onClick={() => handleClick(-1)}
                            className="relative inline-flex items-center rounded-l-md border border-gray-300 bg-white px-2 py-2 text-sm font-medium text-gray-500 hover:cursor-pointer hover:bg-gray-50 focus:z-20 "
                        >
                        ...
                        <div
                            onClick={() => handleClick(1)}
                            className="relative inline-flex items-center rounded-r-md border border-gray-300 bg-white px-2 py-2 text-sm font-medium text-gray-500 hover:cursor-pointer hover:bg-gray-50 focus:z-20 "
                        >
